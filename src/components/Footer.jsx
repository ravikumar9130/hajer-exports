...
export const Footer = () => {
    return (
        ...
        <footer class="bg-primary text-white border-t shadow pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10">
           <div class="container  w-[90%] mx-auto ">
              <div class="flex justify-between flex-wrap -mx-4">
                 ...
                 <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
                    <div class="w-full mb-10">
                       <h4 class=" text-lg font-semibold mb-9">Quick Links</h4>
                            <ul>
                 ...
                 <div class="w-full sm:w-1/2 lg:w-2/12 px-4">
                    <div class="w-full mb-10">
                       <h4 class=" text-lg font-semibold mb-9">Company</h4>
                       <ul>
                          <li>
                             <a
                                href="javascript:void(0)"
                 ...
                 <div class="w-full sm:w-1/2 lg:w-3/12 px-4">
                    <div class="w-full mb-10">
                       <h4 class=" text-lg font-semibold mb-9">Follow Us On</h4>
    ...
    //   <div className="relative mt-16 text-white bg-primary">
    //     <svg
    ...
    //           >
    //             <img className="fill-white w-1/2" src={logo} alt="" />
    //           </a>
