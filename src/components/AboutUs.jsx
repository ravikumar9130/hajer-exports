  ...
  return (
      ...
      <div className="flex gap-4 flex-col justify-between items-center w-[90%] mx-auto md:flex-row-reverse pb-8 pt-12">
        ...
        <div className="mt-4 mx-auto">
          <div className="text-4xl w-full  text-center  text-primary pb-4  md:pb-8">
            About Us
                  </div>
                  <div className="md:text-center md:text-xl"> We, Hajer Exports, situated at address..... are a leading supplier of
